    ...
    public class SysMenuController : BaseController
    {
        ...
        {           
            if (entity != null && ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(Suggestion.InsertSucceed  + "，模块的信息的Id为" + entity.Id,"模块"
                        );//写入日志 
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.InsertFail + "，模块的信息，" + returnValue,"模块"
                        );//写入日志                      
        ...
        public ActionResult Edit(string id, SysMenu entity)
        {
            ...
            {   //数据校验
                ...
                {
                    LogClassModels.WriteServiceLog(Suggestion.UpdateSucceed + "，模块信息的Id为" + id,"模块"
                        );//写入日志                           
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，模块信息的Id为" + id + "," + returnValue, "模块"
                        );//写入日志                           
