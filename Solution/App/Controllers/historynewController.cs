...
{
    public class historynewController : Controller
    {
        //
        // GET: /history/
        ...
        public void BindDpl()
        {
            ...
            ViewBag.dplemployeename = hr.bindDpl("职工姓名");
        }
        ...
        public ActionResult _Index()
        {
            ...
            IEnumerable<CHAIN.DAL.hr_srv_history> history = _historyBLL.Bindhistory1(collection);
        ...
        public ActionResult _Insert_Edit(hr_srv_history item)
        {
            ...
            NameValueCollection collection = new NameValueCollection(Request.QueryString);
            IEnumerable<hr_srv_history> history = _historyBLL.Bindhistory1(collection);
            return View(new GridModel(history));
