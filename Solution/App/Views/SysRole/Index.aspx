<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<CHAIN.DAL.SysRole>" %>
...
<head id="Head1">
    ...
    <link href="<%: Url.Content("~/Res/easyui/themes/icon.css") %>" rel="stylesheet"
        type="text/css" />
    <link href="<%: Url.Content("~/Content/IndexStyle.css") %>" rel="stylesheet" type="text/css" />
...
<body class="easyui-layout">
    <div region="west" split="true" title="模块" style="width: 180px;">
        <ul id="myTree">
        </ul>
    </div>
