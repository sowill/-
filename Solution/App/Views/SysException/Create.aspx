<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Create.Master" Inherits="System.Web.Mvc.ViewPage<CHAIN.DAL.SysException>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset>
        <legend>
            ...
            <input class="submitcss" type="button" onclick="BackList('SysException')" value="返回" />
        </legend>
        <div class="bigdiv">
