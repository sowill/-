<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Index.Master" Inherits="System.Web.Mvc.ViewPage<CHAIN.DAL.SysLog>" %>
        ...
        $(function () {
            ...
            $('#flexigridData').datagrid({
                ...
                columns: [[
					...
					{ field: 'PersonId', title: '<%: Html.LabelFor(model => model.PersonId) %>', width: 113 }
					,{ field: 'Message', title:  '<%: Html.LabelFor(model => model.Message) %>', width: 113 }
					,{ field: 'Result', title:  '<%: Html.LabelFor(model => model.Result) %>', width: 113 }
					,{ field: 'MenuId', title:  '<%: Html.LabelFor(model => model.MenuId) %>', width: 113 }
					,{ field: 'Ip', title:  '<%: Html.LabelFor(model => model.Ip) %>', width: 113 }
            ...
            if (parent == "undefined" || parent == null) {
                //异步获取按钮
                $.getJSON("../Home/GetToolbar", { id: "SysLog", action: "Index" }, function (data) {
                    if (data == null) {
                        return;
                    }              
