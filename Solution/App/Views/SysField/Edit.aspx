<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Edit.Master" Inherits="System.Web.Mvc.ViewPage<CHAIN.DAL.SysField>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset>
        <legend>
            ...
            <input class="submitcss" type="button" onclick="BackList('SysField')" value="返回列表" />
        </legend>
        <div class="bigdiv">
