        ...
        $(function () {
            ...
            $('#flexigridData').datagrid({
                ...
                columns: [[
					...
					,{ field: 'UpdatePerson', title:  '<%: Html.LabelFor(model => model.UpdatePerson) %>', width: 84 }					//, { display: '<%: Html.LabelFor(model => model.SysRoleId) %>', name: 'SysRoleId', width: 84, sortable: false, align: 'left' }
            ...
            if (parent == "undefined" || parent == null) {
                //异步获取按钮
                $.getJSON("../Home/GetToolbar", { id: "SysMenu", action: "Index" }, function (data) {
                    if (data == null) {
                        return;
                    }              
