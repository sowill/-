...
$.widget( "cg.combogrid", {
	...
	_create: function() {
		...
		this.element
            ...
            //Lt修改，增加点击初始化时，加载默认列表
            .bind("keydown.combogrid focus.combogrid", function (event) {
...
// Select page
	...
	_renderPagerPage: function (label, page, total){
		if(this.options.i18n){
			return $.i18n.prop('page')+' <input type="text" size="1" id="currentPage" value="'+ page + '"></input> ' + $.i18n.prop('of') + ' ' + total;
		} else {
			return 'Page <input type="text" size="1" id="currentPage" value="' + page + '"></input> of ' + total;
		}
	},
